...
function Logo({
  ...
  const sizeClass =
    variant === "footer"
      ...
      : "h-12 w-auto shrink-0 sm:h-14 md:h-16";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div>
            <h1 className="mt-5 text-3xl font-extrabold leading-[1.1] sm:text-5xl">
              Limpeza de ar-condicionado em <span className="text-wave">Maceió</span>
            </h1>
      ...
      <Section className="bg-secondary/40">
        ...
        <p className="mt-3 text-sm text-muted-foreground">Avaliações reais de clientes no Google — nota máxima em todos os serviços.</p>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              name: "Alan Matias",
              text: "Profissional competente e muito bem organizado, pontual e cobra o preço justo.",
            },
            {
              name: "Alexsandro Caetano",
              text: "Ótimo profissional muito educado e resolveu rapidamente meu problema.",
            },
            {
              name: "Raul Matcki",
              text: "Excelente serviço! Atendimento rápido, caprichoso e muito profissional. Recomendo demais!",
            },
            {
              name: "Kadu",
              text: "Profissional de respeito, e bastante educado, e com um serviço muito bem feito.",
            },
            {
              name: "Guilherme Toledo",
              text: "Excelente profissional, muito caprichoso e responsável. Recomendo o trabalho da Art Climatização!",
            },
          ].map((review) => (
            <div
              key={review.name}
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-purple/10 font-bold text-brand-purple">
                  {review.name.charAt(0)}
                </div>
                <div>
                  <p className="font-semibold text-foreground">{review.name}</p>
                  <div className="flex gap-0.5 text-yellow-500" aria-label="5 estrelas">
                    {[...Array(5)].map((_, i) => (
